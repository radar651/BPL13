...
/obj/item/weapon/paper/Asylum1
	name = "Asylum Construction Sec Report 1013- Missing Personel "
	info = "<B> Asylum Construction Secuirty Report Number 1013 <B> <BR> Report filed by Officer Darin <br> <br> <br> This is day 13 into the construction of the Prison Insane Asylum amd things have already gone bad.At first it was just tools snapping. Then the autolate they were using further into the building blew out. They ordered a new circut board for it. But now we have 6 missing eingeers. Me, Officer Gorgie and Enigneer Dojo searched the buliding. Only thing we found of them was their hardhats... in a room oddly smelling of Banannas. Nothing else. I am requesting a Secuirty Borg or at least 4 more armed officers."
...
/obj/item/weapon/paper/crumpled/bloody/foreman
	icon_state = "scrap_bloodied"
	name = "Bloodied note"
	info = "Finaly got this damn prison done. Hope those chuckle fucks up at the office enjoy it. 56 accidents... all of them ended in death. For what... a little bit of cash from Nanotrasen? This was not worth my paycheck. I saw the assitant formen run off with the plans for the entire prison yesterday. I asked him about it this morning. He sai-"
