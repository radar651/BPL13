mob/living/carbon/proc/dream()
	...
	var/list/dreams = list(
		...
		"a hat","the prison","a ruined station","a planet","plasma","air","the medical bay","the bridge","blinking lights",
		...
		"the virologist","the roboticist","the chef","the bartender","the chaplain","the librarian", "the brig physician",
		"the barber", "the magistrate", "the nanotrasen representative", "the blueshield", "a mouse","an ert member",
